...
public abstract class ClientEventMixin {
    ...
    @Shadow public abstract void drawVertex(Matrix4f p_229039_1_, Matrix3f p_229039_2_, VertexConsumer p_229039_3_, int p_229039_4_, int p_229039_5_, int p_229039_6_, float p_229039_7_, float p_229039_8_, int p_229039_9_, int p_229039_10_, int p_229039_11_, int p_229039_12_);
    ...
    public void modifyOnPreRenderEntity(RenderLivingEvent.Pre event, CallbackInfo ci) {
        ...
        if (usingImmolator) {
            ...
            float f2 = (float)player.tickCount + event.getPartialTick();
            PoseStack matrixStackIn = event.getPoseStack();
            float f3 = (float)Mth.clamp(i, 1, 45);
            matrixStackIn.pushPose();
